...
import BOBlogo from '../../assets/images/bobtokenlogo.png'
...
`
const BOB_ADDRESS = '0x7d8146cf21e8d7cbe46054e01588207b51198729'
...
export default function CurrencyLogo({
  ...
  const srcs: string[] = useMemo(() => {
    ...
    if (currency.isToken) {
      if (currency.address.toLowerCase() === BOB_ADDRESS.toLowerCase()) {
        return [BOBlogo]
      }
      const defaultUrls = []
