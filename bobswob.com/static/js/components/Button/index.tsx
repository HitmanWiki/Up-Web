...
`
// export const ButtonSwap = styled(BaseButton)`
//   background: ${({ theme }) => theme.primary6};
//   color: '#FFFFFF';
//   font-size: 16px;
//   font-weight: 500;
//   &:focus {
//     background: ${({ theme, disabled }) => (disabled ? theme.primary7 : theme.primary6)});
//   }
//   &:hover {
//     background: ${({ theme, disabled }) => (disabled ? theme.primary7 : theme.primary6)});
//   }
...
export const ButtonCurrency = styled(BaseButton)`
  background-color: ${({ theme }) => theme.bg1};
  color: ${({ theme }) => theme.text2};
  font-family: 'Poppins';
  font-size: 16px;
  ...
  &:hover {
    background-color: ${({ theme, disabled }) => !disabled && darken(0.02, theme.bg1)};
  }
  &:active {
    background-color: ${({ theme, disabled }) => !disabled && darken(0.02, theme.bg1)};
  }
...
export function ButtonDropdownRoutes({ disabled = false, children, ...rest }: { disabled?: boolean } & ButtonProps) {
  return (
    <ButtonPrimary {...rest} disabled={disabled}>
      <RowBetween>
        <div style={{ display: 'flex', alignItems: 'center' }}>{children}</div>
