...
import C from "date-fns/getQuarter";
...
import Y from "date-fns/setYear";
import O from "date-fns/min";
...
import R from "date-fns/differenceInCalendarYears";
...
var Ce = {
        ...
        P: function(e, t) {
            ...
            return r.replace("{{date}}", ke(o, t)).replace("{{time}}", be(a, t))
        }
    },
    Se = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g;

function _e(e) {
    var t = e ? "string" == typeof e || e instanceof String ? Z(e) : J(e) : new Date;
    return Pe(t) ? t : null
}
...
function Me(e, t, r, n, o) {
    ...
    return Array.isArray(t) ? (t.forEach((function(t) {
        var p = X(e, t, new Date, {
            locale: s
        });
        n && (i = Pe(p, o) && e === Ee(p, t, r)), Pe(p, o) && i && (a = p)
    })), a) : (a = X(e, t, new Date, {
        locale: s
    }), n ? i = Pe(a) && e === Ee(a, t, r) : Pe(a) || (t = t.match(Se).map((function(e) {
        var t = e[0];
        return "p" === t || "P" === t ? s ? (0, Ce[t])(e, s.formatLong) : t : e
    })).join(""), e.length > 0 && (a = X(e, t.slice(0, e.length), new Date)), Pe(a) || (a = new Date(e))), Pe(a) && i ? a : null)
}
...
function Ee(e, t, r) {
    if ("en" === r) return a(e, t, {
        awareOfUnicodeTokens: !0
    });
    var n = Ue(r);
    return r && !n && console.warn('A locale object was not found for the provided string ["'.concat(r, '"].')), !n && qe() && Ue(qe()) && (n = Ue(qe())), a(e, t, {
        locale: n || null,
        awareOfUnicodeTokens: !0
    })
}
...
function Ne(e, t) {
    var r = t.dateFormat,
        n = t.locale;
    return e && Ee(e, Array.isArray(r) ? r[0] : r, n) || ""
}
...
function $e(e, t) {
    return Ee(N(_e(), e), "LLLL", t)
}

function ze(e, t) {
    return Ee(N(_e(), e), "LLL", t)
}

function Ge(e, t) {
    return Ee(x(_e(), e), "QQQ", t)
}
...
function et(e, t, r, n) {
    var o = S(e),
        ...
        i = b(t),
        p = S(n);
    return o === s && o === p ? a <= r && r <= i : o < s ? p === o && a <= r || p === s && i >= r || p < s && p > o : void 0
}
...
function pt(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        n = t.includeDates,
        o = m(e, 1);
    return r && L(r, o) > 0 || n && n.every((function(e) {
        return L(e, o) > 0
    })) || !1
}
...
function ct(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        n = t.includeDates,
        o = l(e, 1);
    return r && L(o, r) > 0 || n && n.every((function(e) {
        return L(o, e) > 0
    })) || !1
}
...
function lt(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        n = t.includeDates,
        o = f(e, 1);
    return r && R(r, o) > 0 || n && n.every((function(e) {
        return R(e, o) > 0
    })) || !1
}
...
function dt(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        n = t.includeDates,
        o = d(e, 1);
    return r && R(o, r) > 0 || n && n.every((function(e) {
        return R(o, e) > 0
    })) || !1
}
...
function mt() {
    for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "react-datepicker__day--highlighted", r = new Map, o = 0, a = e.length; o < a; o++) {
        var s = e[o];
        if (n(s)) {
...
var wt = ee(function(n) {
        ...
        function a(r) {
            var n;
            pe(this, a), de(ye(n = o.call(this, r)), "renderOptions", (function() {
                var t = n.props.year,
                    r = n.state.yearsList.map((function(r) {
                        ...
                        }, t === r ? e.createElement("span", {
                            className: "react-datepicker__year-option--selected"
                        }, "✓") : "", r)
                    })),
                    o = n.props.minDate ? S(n.props.minDate) : null,
                    a = n.props.maxDate ? S(n.props.maxDate) : null;
                return a && n.state.yearsList.find((function(e) {
                    return e === a
                })) || r.unshift(e.createElement("div", {
    ...
    gt = function(t) {
        ...
        function n() {
            ...
            return de(ye(t = r.call.apply(r, [this].concat(a))), "state", {
                dropdownVisible: !1
            }), de(ye(t), "renderSelectOptions", (function() {
                for (var r = t.props.minDate ? S(t.props.minDate) : 1900, n = t.props.maxDate ? S(t.props.maxDate) : 2100, o = [], a = r; a <= n; a++) o.push(e.createElement("option", {
                    key: a,
                    value: a
                }, a));
                return o
            })), de(ye(t), "onSelectChange", (function(e) {
                t.onChange(e.target.value)
            })), de(ye(t), "renderSelectMode", (function() {
                return e.createElement("select", {
                    value: t.props.year,
                    className: "react-datepicker__year-select",
                    onChange: t.onSelectChange
                }, t.renderSelectOptions())
            })), de(ye(t), "renderReadView", (function(r) {
                return e.createElement("div", {
                    key: "read",
                    style: {
            ...
            })), de(ye(t), "renderDropdown", (function() {
    ...
    kt = ee(function(t) {
        ...
        function n() {
            ...
            pe(this, n);
            for (var o = arguments.length, a = new Array(o), s = 0; s < o; s++) a[s] = arguments[s];
            return de(ye(t = r.call.apply(r, [this].concat(a))), "isSelectedMonth", (function(e) {
                return t.props.month === e
            })), de(ye(t), "renderOptions", (function() {
                return t.props.monthNames.map((function(r, n) {
                    return e.createElement("div", {
                        ...
                        key: r,
                        onClick: t.onChange.bind(ye(t), n),
                        "aria-selected": t.isSelectedMonth(n) ? "true" : void 0
                    }, t.isSelectedMonth(n) ? e.createElement("span", {
                        className: "react-datepicker__month-option--selected"
                    }, "✓") : "", r)
                }))
            })), de(ye(t), "onChange", (function(e) {
                return t.props.onChange(e)
            })), de(ye(t), "handleClickOutside", (function() {
    ...
    bt = function(t) {
        ...
        function n() {
            ...
            return de(ye(t = r.call.apply(r, [this].concat(a))), "state", {
                dropdownVisible: !1
            }), de(ye(t), "renderSelectOptions", (function(t) {
            ...
            })), de(ye(t), "renderSelectMode", (function(r) {
                return e.createElement("select", {
                    value: t.props.month,
            ...
            })), de(ye(t), "renderReadView", (function(r, n) {
                return e.createElement("div", {
                    key: "read",
                    style: {
                        visibility: r ? "visible" : "hidden"
            ...
            })), de(ye(t), "renderDropdown", (function(r) {
            ...
            })), de(ye(t), "renderScrollMode", (function(e) {
            ...
            })), de(ye(t), "toggleDropdown", (function() {
                return t.setState({
                    dropdownVisible: !t.state.dropdownVisible
                })
            })), t
...
function Ct(e, t) {
    for (var r = [], n = Le(e), o = Le(t); !$(n, o);) r.push(_e(n)), n = l(n, 1);
    return r
}
var St = ee(function(t) {
        he(o, e.Component);
        var n = De(o);

        function o(t) {
            var r;
            return pe(this, o), de(ye(r = n.call(this, t)), "renderOptions", (function() {
                return r.state.monthYearsList.map((function(t) {
                    var n = _(t),
                        o = Ae(r.props.date, t) && Be(r.props.date, t);
                    return e.createElement("div", {
                        className: o ? "react-datepicker__month-year-option--selected_month-year" : "react-datepicker__month-year-option",
                        key: n,
                        onClick: r.onChange.bind(ye(r), n),
                        "aria-selected": o ? "true" : void 0
                    }, o ? e.createElement("span", {
                        className: "react-datepicker__month-year-option--selected"
                    }, "✓") : "", Ee(t, r.props.dateFormat, r.props.locale))
                }))
            })), de(ye(r), "onChange", (function(e) {
                return r.props.onChange(e)
            })), de(ye(r), "handleClickOutside", (function() {
                r.props.onCancel()
            })), r.state = {
    ...
    _t = function(t) {
        ...
        function n() {
            ...
            return de(ye(t = r.call.apply(r, [this].concat(a))), "state", {
                ...
                for (var r = Le(t.props.minDate), n = Le(t.props.maxDate), o = []; !$(r, n);) {
                    var a = _(r);
                    o.push(e.createElement("option", {
                        key: a,
                        value: a
                    }, Ee(r, t.props.dateFormat, t.props.locale))), r = l(r, 1)
                }
                return o
            })), de(ye(t), "onSelectChange", (function(e) {
                t.onChange(e.target.value)
                ...
                return e.createElement("select", {
                    value: _(Le(t.props.date)),
                    className: "react-datepicker__month-year-select",
                    onChange: t.onSelectChange
                }, t.renderSelectOptions())
            })), de(ye(t), "renderReadView", (function(r) {
                var n = Ee(t.props.date, t.props.dateFormat, t.props.locale);
                return e.createElement("div", {
                    key: "read",
                    style: {
                        visibility: r ? "visible" : "hidden"
                ...
                t.toggleDropdown();
                var r = _e(parseInt(e));
                Ae(t.props.date, r) && Be(t.props.date, r) || t.props.onChange(r)
            })), de(ye(t), "toggleDropdown", (function() {
                return t.setState({
                    dropdownVisible: !t.state.dropdownVisible
                })
    ...
    Mt = function(t) {
        ...
        function o() {
            ...
            return de(ye(t = n.call.apply(n, [this].concat(s))), "dayEl", e.createRef()), de(ye(t), "handleClick", (function(e) {
            ...
            })), de(ye(t), "handleOnKeyDown", (function(e) {
                " " === e.key && (e.preventDefault(), e.key = "Enter"), t.props.handleOnKeyDown(e)
            })), de(ye(t), "isSameDay", (function(e) {
                return We(t.props.day, e)
            })), de(ye(t), "isKeyboardSelected", (function() {
                return !t.props.disabledKeyboardNavigation && !t.isSameDay(t.props.selected) && t.isSameDay(t.props.preSelection)
            })), de(ye(t), "isDisabled", (function() {
                return Je(t.props.day, t.props)
            })), de(ye(t), "isExcluded", (function() {
                return Xe(t.props.day, t.props)
                ...
                var e, r = t.props,
                    ...
                    p = r.startDate,
                    c = r.endDate,
                    l = null !== (e = t.props.selectingDate) && void 0 !== e ? e : t.props.preSelection;
                return !(!(o || a || s) || !l || !i && t.isDisabled()) && (o && c && (z(l, c) || je(l, c)) ? He(n, l, c) : (a && p && ($(l, p) || je(l, p)) || !(!s || !p || c || !$(l, p) && !je(l, p))) && He(n, p, l))
                ...
                var r = t.props,
                    ...
                    o = r.startDate,
                    a = r.selectsStart,
                    s = null !== (e = t.props.selectingDate) && void 0 !== e ? e : t.props.preSelection;
                return We(n, a ? s : o)
                ...
                var e = w(t.props.day);
                return 0 === e || 6 === e
            })), de(ye(t), "isAfterMonth", (function() {
                return void 0 !== t.props.month && (t.props.month + 1) % 12 === b(t.props.day)
            })), de(ye(t), "isBeforeMonth", (function() {
                return void 0 !== t.props.month && (b(t.props.day) + 1) % 12 === t.props.month
            })), de(ye(t), "isCurrentDay", (function() {
                return t.isSameDay(_e())
            })), de(ye(t), "isSelected", (function() {
                ...
                return r("react-datepicker__day", n, "react-datepicker__day--" + Oe(t.props.day), {
                ...
                return "".concat(i, " ").concat(Ee(r, "PPPP", t.props.locale))
            })), de(ye(t), "getTabIndex", (function(e, r) {
                var n = e || t.props.selected,
                    o = r || t.props.preSelection;
                return t.isKeyboardSelected() || t.isSameDay(n) && We(o, n) ? 0 : -1
            })), de(ye(t), "handleFocusDay", (function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    r = !1;
                0 === t.getTabIndex() && !e.isInputFocused && t.isSameDay(t.props.preSelection) && (document.activeElement && document.activeElement !== document.body || (r = !0), t.props.inline && !t.props.shouldFocusDayInline && (r = !1), t.props.containerRef && t.props.containerRef.current && t.props.containerRef.current.contains(document.activeElement) && document.activeElement.classList.contains("react-datepicker__day") && (r = !0)), r && t.dayEl.current.focus({
                    preventScroll: !0
                })
            })), de(ye(t), "renderDayContents", (function() {
                return t.props.monthShowsDuplicateDaysEnd && t.isAfterMonth() || t.props.monthShowsDuplicateDaysStart && t.isBeforeMonth() ? null : t.props.renderDayContents ? t.props.renderDayContents(g(t.props.day), t.props.day) : g(t.props.day)
            })), de(ye(t), "render", (function() {
                return e.createElement("div", {
                    ref: t.dayEl,
    ...
    Pt = function(t) {
        ...
        function o() {
            ...
            return de(ye(e = n.call.apply(n, [this].concat(r))), "handleClick", (function(t) {
    ...
    Et = function(t) {
        ...
        function n() {
            ...
            pe(this, n);
            for (var o = arguments.length, a = new Array(o), s = 0; s < o; s++) a[s] = arguments[s];
            return de(ye(t = r.call.apply(r, [this].concat(a))), "handleDayClick", (function(e, r) {
                t.props.onDayClick && t.props.onDayClick(e, r)
            })), de(ye(t), "handleDayMouseEnter", (function(e) {
                t.props.onDayMouseEnter && t.props.onDayMouseEnter(e)
            })), de(ye(t), "handleWeekClick", (function(e, r, n) {
                "function" == typeof t.props.onWeekSelect && t.props.onWeekSelect(e, r, n), t.props.shouldCloseOnSelect && t.props.setOpen(!1)
            })), de(ye(t), "formatWeekNumber", (function(e) {
                return t.props.formatWeekNumber ? t.props.formatWeekNumber(e) : Ye(e)
            })), de(ye(t), "renderDays", (function() {
                var r = Te(t.props.day, t.props.locale, t.props.calendarStartDay),
                    n = [],
                    o = t.formatWeekNumber(r);
                if (t.props.showWeekNumber) {
                    var a = t.props.onWeekSelect ? t.handleWeekClick.bind(ye(t), r, o) : void 0;
                    n.push(e.createElement(Pt, {
                        key: "W",
                        weekNumber: o,
                        onClick: a,
                ...
                return n.concat([0, 1, 2, 3, 4, 5, 6].map((function(n) {
                    ...
                    return e.createElement(Mt, {
                        ...
                        day: o,
                        month: t.props.month,
                        onClick: t.handleDayClick.bind(ye(t), o),
                        onMouseEnter: t.handleDayMouseEnter.bind(ye(t), o),
                        minDate: t.props.minDate,
                        maxDate: t.props.maxDate,
    ...
    Nt = function(t) {
        ...
        function o() {
            ...
            pe(this, o);
            for (var a = arguments.length, s = new Array(a), i = 0; i < a; i++) s[i] = arguments[i];
            return de(ye(t = n.call.apply(n, [this].concat(s))), "MONTH_REFS", we(Array(12)).map((function() {
                return e.createRef()
            }))), de(ye(t), "isDisabled", (function(e) {
                return Je(e, t.props)
            })), de(ye(t), "isExcluded", (function(e) {
                return Xe(e, t.props)
            })), de(ye(t), "handleDayClick", (function(e, r) {
                t.props.onDayClick && t.props.onDayClick(e, r, t.props.orderInDisplay)
            })), de(ye(t), "handleDayMouseEnter", (function(e) {
                t.props.onDayMouseEnter && t.props.onDayMouseEnter(e)
            })), de(ye(t), "handleMouseLeave", (function() {
                t.props.onMouseLeave && t.props.onMouseLeave()
            })), de(ye(t), "isRangeStartMonth", (function(e) {
                var r = t.props,
                    n = r.day,
                    o = r.startDate,
                    a = r.endDate;
                return !(!o || !a) && Be(N(n, e), o)
            })), de(ye(t), "isRangeStartQuarter", (function(e) {
                var r = t.props,
                    n = r.day,
                    o = r.startDate,
                    a = r.endDate;
                return !(!o || !a) && Ke(x(n, e), o)
            })), de(ye(t), "isRangeEndMonth", (function(e) {
                var r = t.props,
                    n = r.day,
                    o = r.startDate,
                    a = r.endDate;
                return !(!o || !a) && Be(N(n, e), a)
            })), de(ye(t), "isRangeEndQuarter", (function(e) {
                var r = t.props,
                    n = r.day,
                    o = r.startDate,
                    a = r.endDate;
                return !(!o || !a) && Ke(x(n, e), a)
            })), de(ye(t), "isWeekInMonth", (function(e) {
                var r = t.props.day,
                    n = p(e, 6);
                return Be(e, r) || Be(n, r)
            })), de(ye(t), "isCurrentMonth", (function(e, t) {
                return S(e) === S(_e()) && t === b(_e())
            })), de(ye(t), "isSelectedMonth", (function(e, t, r) {
                return b(e) === t && S(e) === S(r)
            })), de(ye(t), "isSelectedQuarter", (function(e, t, r) {
                return C(e) === t && S(e) === S(r)
            })), de(ye(t), "renderWeeks", (function() {
                for (var r = [], n = t.props.fixedHeight, o = 0, a = !1, s = Te(Le(t.props.day), t.props.locale, t.props.calendarStartDay); r.push(e.createElement(Et, {
                ...
                return r
            })), de(ye(t), "onMonthClick", (function(e, r) {
                t.handleDayClick(Le(N(t.props.day, r)), e)
            })), de(ye(t), "handleMonthNavigation", (function(e, r) {
                t.isDisabled(r) || t.isExcluded(r) || (t.props.setPreSelection(r), t.MONTH_REFS[e].current && t.MONTH_REFS[e].current.focus())
            })), de(ye(t), "onMonthKeyDown", (function(e, r) {
                var n = e.key;
                if (!t.props.disabledKeyboardNavigation) switch (n) {
                    case "Enter":
                        t.onMonthClick(e, r), t.props.setPreSelection(t.props.selected);
                        break;
                    case "ArrowRight":
                        t.handleMonthNavigation(11 === r ? 0 : r + 1, l(t.props.preSelection, 1));
                        break;
                    case "ArrowLeft":
                        t.handleMonthNavigation(0 === r ? 11 : r - 1, m(t.props.preSelection, 1))
                }
            })), de(ye(t), "onQuarterClick", (function(e, r) {
                t.handleDayClick(Fe(x(t.props.day, r)), e)
            })), de(ye(t), "getMonthClassNames", (function(e) {
                var n = t.props,
                    o = n.day,
                    a = n.startDate,
                    s = n.endDate,
                    ...
                    d = n.monthClassName,
                    u = d ? d(o) : void 0;
                return r("react-datepicker__month-text", "react-datepicker__month-".concat(e), u, {
                    "react-datepicker__month--disabled": (p || c) && Ze(N(o, e), t.props),
                    "react-datepicker__month--selected": t.isSelectedMonth(o, e, i),
                    "react-datepicker__month-text--keyboard-selected": b(l) === e,
                    "react-datepicker__month--in-range": et(a, s, e, o),
            ...
            })), de(ye(t), "getQuarterClassNames", (function(e) {
                var n = t.props,
                    o = n.day,
                    a = n.startDate,
                    s = n.endDate,
                    ...
                    p = n.minDate,
                    c = n.maxDate;
                return r("react-datepicker__quarter-text", "react-datepicker__quarter-".concat(e), {
                    "react-datepicker__quarter--disabled": (p || c) && tt(x(o, e), t.props),
                    "react-datepicker__quarter--selected": t.isSelectedQuarter(o, e, i),
                    "react-datepicker__quarter--in-range": nt(a, s, e, o),
                    "react-datepicker__quarter--range-start": t.isRangeStartQuarter(e),
                    "react-datepicker__quarter--range-end": t.isRangeEndQuarter(e)
                })
            })), de(ye(t), "renderMonths", (function() {
                var r = t.props,
            ...
            })), de(ye(t), "renderQuarters", (function() {
                var r = t.props,
                    n = r.day,
                    o = r.selected;
                return e.createElement("div", {
            ...
            })), de(ye(t), "getClassNames", (function() {
                var e = t.props;
                e.day;
        ...
        return le(o, [{
            ...
            value: function() {
                ...
                return e.createElement("div", {
                    ...
                    "aria-label": "".concat(s, " ").concat(Ee(o, "yyyy-MM")),
                    role: "listbox"
    ...
    xt = function(t) {
        ...
        function n() {
            ...
            return de(ye(t = r.call.apply(r, [this].concat(a))), "state", {
                height: null
            }), de(ye(t), "handleClick", (function(e) {
                (t.props.minTime || t.props.maxTime) && it(e, t.props) || (t.props.excludeTimes || t.props.includeTimes || t.props.filterTime) && st(e, t.props) || t.props.onChange(e)
            })), de(ye(t), "isSelectedTime", (function(e, r, n) {
                return t.props.selected && r === D(e) && n === v(e)
            })), de(ye(t), "liClasses", (function(e, r, n) {
                var o = ["react-datepicker__time-list-item", t.props.timeClassName ? t.props.timeClassName(e, r, n) : void 0];
                return t.isSelectedTime(e, r, n) && o.push("react-datepicker__time-list-item--selected"), ((t.props.minTime || t.props.maxTime) && it(e, t.props) || (t.props.excludeTimes || t.props.includeTimes || t.props.filterTime) && st(e, t.props)) && o.push("react-datepicker__time-list-item--disabled"), t.props.injectTimes && (60 * D(e) + v(e)) % t.props.intervals != 0 && o.push("react-datepicker__time-list-item--injected"), o.join(" ")
            })), de(ye(t), "handleOnKeyDown", (function(e, r) {
                " " === e.key && (e.preventDefault(), e.key = "Enter"), "Enter" === e.key && t.handleClick(r), t.props.handleOnKeyDown(e)
            })), de(ye(t), "renderTimes", (function() {
                for (var r = [], n = t.props.format ? t.props.format : "p", o = t.props.intervals, a = Ie(_e(t.props.selected)), i = 1440 / o, p = t.props.injectTimes && t.props.injectTimes.sort((function(e, t) {
                        return e - t
                    })), c = t.props.selected || t.props.openToDate || _e(), l = D(c), d = v(c), u = E(P(a, d), l), h = 0; h < i; h++) {
                    var m = s(a, h * o);
                    if (r.push(m), p) {
                        var f = ft(a, m, h, o, p);
                        r = r.concat(f)
                ...
                return r.map((function(r, o) {
                    return e.createElement("li", {
                        key: o,
                        onClick: t.handleClick.bind(ye(t), r),
                        className: t.liClasses(r, l, d),
                        ref: function(e) {
                            (z(r, u) || je(r, u)) && (t.centerLi = e)
                        },
                        onKeyDown: function(e) {
        ...
        return le(n, [{
            ...
            value: function() {
                ...
                }, this.props.timeCaption)), e.createElement("div", {
...
de(xt, "calcCenterPosition", (function(e, t) {
...
var Yt = function(t) {
        ...
        function o(t) {
            var a;
            return pe(this, o), de(ye(a = n.call(this, t)), "YEAR_REFS", we(Array(a.props.yearItemNumber)).map((function() {
                return e.createRef()
            }))), de(ye(a), "isDisabled", (function(e) {
                return Je(e, a.props)
            })), de(ye(a), "isExcluded", (function(e) {
                return Xe(e, a.props)
            })), de(ye(a), "updateFocusOnPaginate", (function(e) {
                var t = function() {
                    this.YEAR_REFS[e].current.focus()
                }.bind(ye(a));
                window.requestAnimationFrame(t)
            })), de(ye(a), "handleYearClick", (function(e, t) {
                a.props.onDayClick && a.props.onDayClick(e, t)
            })), de(ye(a), "handleYearNavigation", (function(e, t) {
                var r = a.props,
                    n = r.date,
                    o = r.yearItemNumber,
                    s = vt(n, o).startPeriod;
            ...
            })), de(ye(a), "isSameDay", (function(e, t) {
                return We(e, t)
            })), de(ye(a), "isCurrentYear", (function(e) {
                return e === S(_e())
            })), de(ye(a), "isKeyboardSelected", (function(e) {
                var t = Re(Y(a.props.date, e));
                return !a.props.disabledKeyboardNavigation && !a.props.inline && !We(t, Re(a.props.selected)) && We(t, Re(a.props.preSelection))
            })), de(ye(a), "onYearClick", (function(e, t) {
                var r = a.props.date;
                a.handleYearClick(Re(Y(r, t)), e)
            })), de(ye(a), "onYearKeyDown", (function(e, t) {
                var r = e.key;
            ...
            })), de(ye(a), "getYearClassNames", (function(e) {
                var t = a.props,
                    n = t.minDate,
                    o = t.maxDate,
                    s = t.selected;
                return r("react-datepicker__year-text", {
                    "react-datepicker__year-text--selected": e === S(s),
                    "react-datepicker__year-text--disabled": (n || o) && rt(e, a.props),
                    "react-datepicker__year-text--keyboard-selected": a.isKeyboardSelected(e),
                    "react-datepicker__year-text--today": a.isCurrentYear(e)
                })
            })), de(ye(a), "getYearTabIndex", (function(e) {
                return a.props.disabledKeyboardNavigation ? "-1" : e === S(a.props.preSelection) ? "0" : "-1"
            })), a
        }
        return le(o, [{
            key: "render",
            value: function() {
                for (var t = this, r = [], n = this.props, o = vt(n.date, n.yearItemNumber), a = o.startPeriod, s = o.endPeriod, i = function(n) {
                        r.push(e.createElement("div", {
                            ref: t.YEAR_REFS[n - a],
                            onClick: function(e) {
                                t.onYearClick(e, n)
    ...
    Ot = function(t) {
        ...
        function n(t) {
            var o;
            return pe(this, n), de(ye(o = r.call(this, t)), "onTimeChange", (function(e) {
                o.setState({
                    time: e
                });
                var t = new Date;
        ...
        return le(n, [{
            ...
            value: function() {
                ...
                }, this.props.timeInputLabel), e.createElement("div", {
...
var Tt = ["react-datepicker__year-select", "react-datepicker__month-select", "react-datepicker__month-year-select"],
    Lt = function(t) {
        ...
        function o(t) {
            var a;
            return pe(this, o), de(ye(a = n.call(this, t)), "handleClickOutside", (function(e) {
                a.props.onClickOutside(e)
            })), de(ye(a), "setClickOutsideRef", (function() {
                return a.containerRef.current
            })), de(ye(a), "handleDropdownFocus", (function(e) {
                (function() {
            ...
            })), de(ye(a), "handleDayClick", (function(e, t, r) {
            ...
            })), de(ye(a), "handleYearChange", (function(e) {
            ...
            })), de(ye(a), "handleMonthChange", (function(e) {
            ...
            })), de(ye(a), "handleMonthYearChange", (function(e) {
                a.handleYearChange(e), a.handleMonthChange(e)
            })), de(ye(a), "changeYear", (function(e) {
            ...
            })), de(ye(a), "changeMonth", (function(e) {
                a.setState((function(t) {
                    var r = t.date;
                    return {
                        date: N(r, e)
            ...
            })), de(ye(a), "changeMonthYear", (function(e) {
                a.setState((function(t) {
                    var r = t.date;
                    return {
                        date: Y(N(r, b(e)), S(e))
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : a.state.date,
                    n = Te(t, a.props.locale, a.props.calendarStartDay),
                    o = [];
                return a.props.showWeekNumbers && o.push(e.createElement("div", {
                    key: "W",
                    className: "react-datepicker__day-name"
                }, a.props.weekLabel || "#")), o.concat([0, 1, 2, 3, 4, 5, 6].map((function(t) {
                    var o = p(n, t),
            ...
            })), de(ye(a), "formatWeekday", (function(e, t) {
                ...
                if (!a.props.renderCustomHeader) {
                    ...
                    if ((a.props.forceShowMonthNavigation || a.props.showDisabledMonthNavigation || !t) && !a.props.showTimeSelectOnly) {
                        ...
                        var o = a.props.showMonthYearPicker || a.props.showQuarterYearPicker || a.props.showYearPicker,
                            ...
                            u = void 0 === l ? "string" == typeof i ? i : "Next Month" : l,
                ...
                return a.props.showYearDropdown && r.push("react-datepicker__current-month--hasYearDropdown"), a.props.showMonthDropdown && r.push("react-datepicker__current-month--hasMonthDropdown"), a.props.showMonthYearDropdown && r.push("react-datepicker__current-month--hasMonthYearDropdown"), e.createElement("div", {
                    className: r.join(" ")
                }, Ee(t, a.props.dateFormat, a.props.locale))
            })), de(ye(a), "renderYearDropdown", (function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                if (a.props.showYearDropdown && !t) return e.createElement(gt, {
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                if (a.props.showMonthDropdown && !t) return e.createElement(bt, {
                    dropdownMode: a.props.dropdownMode,
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                if (a.props.showMonthYearDropdown && !t) return e.createElement(_t, {
                    dropdownMode: a.props.dropdownMode,
                    locale: a.props.locale,
                ...
                if (a.props.todayButton && !a.props.showTimeSelectOnly) return e.createElement("div", {
                    className: "react-datepicker__today-button",
                    onClick: function(e) {
                        return a.props.onSelect(F(_e()), e)
                    }
                }, a.props.todayButton)
            })), de(ye(a), "renderDefaultHeader", (function(t) {
                var r = t.monthDate,
                    n = t.i;
                return e.createElement("div", {
                    className: "react-datepicker__header ".concat(a.props.showTimeSelect ? "react-datepicker__header--has-time-select" : "")
                }, a.renderCurrentMonth(r), e.createElement("div", {
                ...
                }, a.renderMonthDropdown(0 !== n), a.renderMonthYearDropdown(0 !== n), a.renderYearDropdown(0 !== n)), e.createElement("div", {
                ...
                }, a.props.renderCustomHeader(se(se({}, a.state), {}, {
                    customHeaderCount: n,
                    monthDate: r,
                ...
                var t = a.state.date,
                    r = a.props,
                    n = r.showYearPicker,
                    o = vt(t, r.yearItemNumber),
                    s = o.startPeriod,
                    i = o.endPeriod;
                return e.createElement("div", {
                    className: "react-datepicker__header react-datepicker-year-header"
                }, n ? "".concat(s, " - ").concat(i) : S(t))
            })), de(ye(a), "renderHeader", (function(e) {
                switch (!0) {
                ...
                if (!a.props.showTimeSelectOnly && !a.props.showYearPicker) {
                    for (var t = [], r = a.props.showPreviousMonths ? a.props.monthsShown - 1 : 0, n = m(a.state.date, r), o = 0; o < a.props.monthsShown; ++o) {
                ...
                if (!a.props.showTimeSelectOnly) return a.props.showYearPicker ? e.createElement("div", {
                    className: "react-datepicker__year--container"
                }, a.renderHeader(), e.createElement(Yt, ue({
                    onDayClick: a.handleDayClick,
                    date: a.state.date
                }, a.props))) : void 0
            })), de(ye(a), "renderTimeSection", (function() {
                if (a.props.showTimeSelect && (a.state.monthContainer || a.props.showTimeSelectOnly)) return e.createElement(xt, {
                    selected: a.props.selected,
                ...
                var t = new Date(a.props.selected),
                    r = Pe(t) && Boolean(a.props.selected) ? "".concat(yt(t.getHours()), ":").concat(yt(t.getMinutes())) : "";
                if (a.props.showTimeInput) return e.createElement(Ot, {
                    date: t,
                    timeString: r,
            ...
            })), a.containerRef = e.createRef(), a.state = {
        ...
        return le(o, [{
            ...
            key: "componentDidUpdate",
            value: function(e) {
                this.props.preSelection && !We(this.props.preSelection, e.preSelection) ? this.setState({
                    date: this.props.preSelection
                }) : this.props.openToDate && !We(this.props.openToDate, e.openToDate) && this.setState({
    ...
    Rt = function(t) {
        ...
        function n(e) {
            var t;
            return pe(this, n), (t = r.call(this, e)).el = document.createElement("div"), t
        }
        return le(n, [{
            key: "componentDidMount",
            value: function() {
    ...
    At = function(t) {
        ...
        function n(t) {
            var o;
            return pe(this, n), de(ye(o = r.call(this, t)), "getTabChildren", (function() {
            ...
            })), de(ye(o), "handleFocusStart", (function(e) {
                var t = o.getTabChildren();
                t && t.length > 1 && t[t.length - 1].focus()
            })), de(ye(o), "handleFocusEnd", (function(e) {
                var t = o.getTabChildren();
                t && t.length > 1 && t[0].focus()
            })), o.tabLoopRef = e.createRef(), o
        }
        return le(n, [{
            key: "render",
            value: function() {
                return this.props.enableTabLoop ? e.createElement("div", {
    ...
    Bt = function(t) {
        ...
        return le(o, [{
            ...
            value: function() {
                ...
                this.props.popperContainer && (t = e.createElement(this.props.popperContainer, {}, t)), m && !s && (t = e.createElement(Rt, {
                    portalId: m,
                    portalHost: f
                }, t));
...
var Wt = function(t) {
        ...
        function a(t) {
            var s;
            return pe(this, a), de(ye(s = o.call(this, t)), "getPreSelection", (function() {
                ...
                var e, t = s.getPreSelection(),
                    r = ut(s.props),
                    n = ht(s.props),
                    o = r && z(t, F(r)) ? r : n && $(t, j(n)) ? n : t;
                return {
                    open: s.props.startOpen || !1,
                    preventFocus: !1,
                    preSelection: null !== (e = s.props.selectsRange ? s.props.startDate : s.props.selected) && void 0 !== e ? e : o,
                    highlightDates: mt(s.props.highlightDates),
                    focused: !1,
            ...
            })), de(ye(s), "handleFocus", (function(e) {
                ...
                var n = t[0];
                if (!s.props.onChangeRaw || (s.props.onChangeRaw.apply(ye(s), t), "function" == typeof n.isDefaultPrevented && !n.isDefaultPrevented())) {
                    s.setState({
                        inputValue: n.target.value,
                        lastPreSelectChange: jt
                    });
                    var o = Me(n.target.value, s.props.dateFormat, s.props.locale, s.props.strictParsing, s.props.minDate);
                    !o && n.target.value || s.setSelected(o, n, !0)
                }
            })), de(ye(s), "handleSelect", (function(e, t, r) {
                if (s.setState({
                        preventFocus: !0
                    }, (function() {
                    ...
                    })), s.props.onChangeRaw && s.props.onChangeRaw(t), s.setSelected(e, t, !1, r), !s.props.shouldCloseOnSelect || s.props.showTimeSelect) s.setPreSelection(e);
            ...
            })), de(ye(s), "setSelected", (function(e, t, r, n) {
                var o = e;
                if (null === o || !Je(o, s.props)) {
                    var a = s.props,
                        i = a.onChange,
                        p = a.selectsRange,
                        c = a.startDate,
                        l = a.endDate;
                    if (!je(s.props.selected, o) || s.props.allowSameDay || p)
                        if (null !== o && (!s.props.selected || r && (s.props.showTimeSelect || s.props.showTimeSelectOnly || s.props.showTimeInput) || (o = xe(o, {
                            ...
                            var d = c && !l,
                                u = c && l;
                            !c && !l ? i([o, null], t) : d && (z(o, c) ? i([o, null], t) : i([c, o], t)), u && i([o, null], t)
                        } else i(o, t);
                    r || (s.props.onSelect(o, t), s.setState({
                        inputValue: null
                    }))
                }
            })), de(ye(s), "setPreSelection", (function(e) {
                var t = void 0 !== s.props.minDate,
                    r = void 0 !== s.props.maxDate,
                    n = !0;
                if (e) {
                    var o = F(e);
                    if (t && r) n = He(e, s.props.minDate, s.props.maxDate);
                    else if (t) {
            ...
            })), de(ye(s), "handleTimeChange", (function(e) {
                var t = xe(s.props.selected ? s.props.selected : s.getPreSelection(), {
                    hour: D(e),
                    minute: v(e)
                });
                s.setState({
            ...
            })), de(ye(s), "onInputKeyDown", (function(e) {
                s.props.onKeyDown(e);
                var t = e.key;
                if (s.state.open || s.props.inline || s.props.preventOpenOnFocus) {
                    if (s.state.open) {
                        ...
                        "Enter" === t ? (e.preventDefault(), s.inputOk() && s.state.lastPreSelectChange === Ht ? (s.handleSelect(n, e), !s.props.shouldCloseOnSelect && s.setPreSelection(n)) : s.setOpen(!1)) : "Escape" === t && (e.preventDefault(), s.setOpen(!1)), s.inputOk() || s.props.onInputError({
                            code: 1,
                            msg: "Date input not valid."
                        })
                    }
                } else "ArrowDown" !== t && "ArrowUp" !== t && "Enter" !== t || s.onInputClick()
            })), de(ye(s), "onDayKeyDown", (function(e) {
                s.props.onKeyDown(e);
                var t = e.key,
                    r = _e(s.state.preSelection);
                if ("Enter" === t) e.preventDefault(), s.handleSelect(r, e), !s.props.shouldCloseOnSelect && s.setPreSelection(r);
                else if ("Escape" === t) e.preventDefault(), s.setOpen(!1), s.inputOk() || s.props.onInputError({
                    code: 1,
                    msg: "Date input not valid."
                });
                    ...
                    if (e.preventDefault(), s.setState({
                            lastPreSelectChange: Ht
                        }), s.props.adjustDateOnChange && s.setSelected(n), s.setPreSelection(n), s.props.inline) {
                        var o = b(r),
                            a = b(n),
                            i = S(r),
                            y = S(n);
            ...
            })), de(ye(s), "onPopperKeyDown", (function(e) {
            ...
            })), de(ye(s), "onClearClick", (function(e) {
                e && e.preventDefault && e.preventDefault(), s.props.selectsRange ? s.props.onChange([null, null], e) : s.props.onChange(null, e), s.setState({
                    inputValue: null
                })
            })), de(ye(s), "clear", (function() {
                s.onClearClick()
            })), de(ye(s), "onScroll", (function(e) {
                ...
                return s.props.inline || s.isCalendarOpen() ? e.createElement(Kt, {
                    ref: function(e) {
                        s.calendar = e
                    },
                    ...
                    showFourColumnMonthYearPicker: s.props.showFourColumnMonthYearPicker,
                ...
                var t = s.props,
                    ...
                    l = t.ariaLabelClose,
                    d = void 0 === l ? "Close" : l;
                return !r || null == n && null == o && null == a ? null : e.createElement("button", {
                    type: "button",
        ...
        return le(a, [{
            ...
            value: function(e, t) {
                var r, n;
                e.inline && (r = e.selected, n = this.props.selected, r && n ? b(r) !== b(n) || S(r) !== S(n) : r !== n) && this.setPreSelection(this.props.selected), void 0 !== this.state.monthSelectedIn && e.monthsShown !== this.props.monthsShown && this.setState({
                    monthSelectedIn: 0
                }), e.highlightDates !== this.props.highlightDates && this.setState({
                    highlightDates: mt(this.props.highlightDates)
                }), t.focused || je(e.selected, this.props.selected) || this.setState({
                    inputValue: null
            ...
            value: function() {
                ...
                if (this.props.withPortal) {
                    var r = this.state.open ? e.createElement("div", {
                        className: "react-datepicker__portal"
                    }, t) : null;
                    return this.state.open && this.props.portalId && (r = e.createElement(Rt, {
                        portalId: this.props.portalId,
                        portalHost: this.props.portalHost
                    }, r)), e.createElement("div", null, this.renderInputContainer(), r)
                }
    ...
    Ht = "navigate";
export {
    It as CalendarContainer, Wt as
    default, qe as getDefaultLocale, Qe as registerLocale, Ve as setDefaultLocale
};